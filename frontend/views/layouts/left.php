        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => '<i class="fa fa-dashboard"></i><span>Penyedia</span>', 'url' => ['/penyedia/index']],
                    [
        ...
        <!-- <ul class="sidebar-menu">
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?= \yii\helpers\Url::to(['/penyedia/index']) ?>"><span class="fa fa-dashboard"></span> Penyedia</a>
                    </li>
                    <li>
